...
<header class="topbar" data-navbarbg="skin6">
    <nav class="navbar top-navbar navbar-expand-md">
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="index.html">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        {{-- <img src="{{asset('dash/images/tan.png')}}" alt="homepage" class="dark-logo" /> --}}
                        <!-- Light Logo icon -->
                        {{-- <img src="{{asset('dash/images/tan.png')}}" alt="homepage" class="light-logo" /> --}}
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="{{asset('assets/website/assets/images/star.png')}}" height="75px" width="150px"
                            alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->
                        {{-- <img src="{{asset('dash/images/tan.png')}}" class="light-logo" alt="homepage" /> --}}
                    </span>
                </a>
            </div>
            <!-- ============================================================== -->
        ...
        <!-- End Logo -->
        <!-- ============================================================== -->
        <div class="navbar-collapse collapse" id="navbarSupportedContent" style="background-color:#fc6203">
            <!-- ============================================================== -->
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <span class="ml-2 d-none d-lg-inline-block"><span style="color:white">Hello,</span> <span
                                style="color:white">{{Auth::user()->name}}</span> <i data-feather="chevron-down"
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)"><i data-feather="settings"
                            ...
                            Account Setting</a> --}}
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{url('bye')}}"><i data-feather="power"
                                class="svg-icon mr-2 ml-1"></i>
                            Logout</a>
                        {{-- <div class="dropdown-divider"></div>
