        ...
        {{-- <div class="row">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="footer-logo-area">
                    <a href="index.html"><img src="{{asset('assets/website/assets/images/white-logo.png')}}"
                            alt="image"></a>
                    <p>Gliter partners with businesses across every major industry to make amazing products and
                        connect the dots between people to people.</p>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="footer-links footer-news-area pr-20">
                    ...
                    <div class="footer-news-card">
                        <p>18-August-2021</p>
                        <h5><a href="blog-details.html">The New Instagram Algorithm, And Why You Shouldn’t Panic</a>
                        </h5>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="footer-links footer-contact">
                    <h3>Contact Us</h3>
                    <ul>
                        <li><span>Our Address:</span> <a href="https://goo.gl/maps/RkJJyk43P9ZQbULs9"
                                target="_blank">2 Street Name, New York, United States of America</a></li>
                        <li><span>Our Email:</span> <a
                                href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#6008050c0c0f20070c091405124e030f0d"><span
                                    class="__cf_email__"
                                    data-cfemail="eb838e878784ab8c87829f8e99c5888486">[email&#160;protected]</span></a>
                        </li>
                        <li><span>Our Phone:</span> <a href="tel:+029222110">+(029-22-2110)</a></li>
                        <li><span>Opening Hours:</span> 10:00 - 18:00</li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="footer-links footer-newsletter">
                    ...
                    <form class="newsletter-form" data-toggle="validator">
                        ...
                        <button class="default-button">Subscribe Now <i class="fas fa-arrow-right"></i></button>
                    </form>
                </div>
            </div>
        </div> --}}
...
<script src="{{asset('assets/website/assets/js/meanmenu.js')}}"></script>
...
<script src="{{asset('assets/website/assets/js/countdown.min.js')}}"></script>
<script src="{{asset('assets/website/assets/js/appear.min.js')}}"></script>
